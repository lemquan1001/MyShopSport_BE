...
public class ProductDetailsController {
   ...
   /* @PostMapping("/searchT")
    ...
    @GetMapping("/geProductDetailById/{product}")
    ResponseEntity getProductDetailById(@PathVariable(name="product")Product_T product){
        return ResponseEntity.ok(new BaseResponse(productService.getProductDetailById(product),"Thành công",StatusCode.SUCCESS));
    }
